    ...
    <section ref={ref} className="relative min-h-screen flex flex-col pt-20 pb-12 overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <motion.div className="max-w-3xl mx-auto text-center space-y-6 mt-12 sm:mt-16 lg:mt-20">
          ...
          >
            Binder OS replaces the chaos of spreadsheets, WhatsApp groups, and disconnected registers with a single manufacturing operating system built for India's textile ecosystem. We start where every factory starts — with inventory.
          </motion.p>
