...
const items = [
  ...
  },
  {
    icon: Smartphone,
    title: "Binder Lite",
    desc: "A standalone product for job workers — independently useful from day one. No dependency on a parent factory's onboarding. Track incoming orders, manage production, and build reputation.",
    extra: null,
  },
];
