...
const features = [
  ...
  },
  {
    ...
    desc: "Digital replacements for the paper registers every factory maintains. Linked to challans, purchase orders, and job orders automatically.",
    direction: { x: 60, y: 20 },
  },
  {
    icon: Building2,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <AnimatedSection className="max-w-3xl mb-20">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-[1.7] mb-5">
            Every factory operation — production, dispatching, quality, costing — depends on knowing exactly what you have, where it is, and where it came from. That's why Binder OS starts with a complete Inventory Management System.
          </p>
