...
const steps = [
  {
    ...
    networkDesc: "Factory → Job Workers",
  },
  {
    icon: Truck,
  ...
  },
  {
    ...
    desc: "Every transaction — every challan, every job order, every quality check — feeds into a growing body of operational data unique to your factory. The longer you run on Binder OS, the clearer your patterns, costs, and bottlenecks become.",
    color: "from-primary/10 to-primary/5",
